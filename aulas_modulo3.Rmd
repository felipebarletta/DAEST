...
plot(base$Renda, base$Despesas, main= "Renda x despesas", ylab= "Despesas", xlab="Renda", ylim=c(0,5),xlim=c(0,8),
     pch=16, col="blue",cex.main=1.5, cex=1.5,cex.lab=1.2, cex.axis=1,bty="l")
...
legend("topleft",legend=c("Modelo 1: Y=2.2 + e","Modelo 2: Y=2X + e",
...
sum((base$Despesas-model1)^2)
sum((base$Despesas-model2)^2)
sum((base$Despesas-model3)^2)
...
text(20,5,"Y=0.57+0.066X+e", col="red")
...
# O quarteto Anscombes consiste em 4 conjuntos de dados x, y que foram publicados por Francis Anscombe em um paper de 1973.
head(anscombe)
# Média
...
url <- "https://www.ime.usp.br/~noproest/dados/questionario.txt"
...
library(ggplot2)
#ggplot(data=dados,aes(y=Y,x=X))+geom_point()
```
