...
<!-- **Exemplo - Dados da Web (web_data.csv:)** -->
<!-- Uma empresa que vende um serviço deseja testar qual das duas layout na Web faz um trabalho de venda melhor. Uma possível variável para a empresa é o número de cliques nas informações detalhadas página de destino. Outra possibilidade melhor é quanto tempo as pessoas passam na página. É razoável que uma apresentação da web que prenda a atenção das pessoas por mais tempo levará a mais vendas. Portanto, a métrica usada é o tempo da sessão, comparando a página A à página B. -->
...
<!-- library(ggplot2) -->
<!-- ggplot(web_data, aes(x=Page, y=Time) )+  -->
<!--     geom_boxplot() -->
<!-- ``` -->

<!-- - Medidas -->
<!-- ```{R k2} -->
<!-- mean_PagA <- mean(page_A)  -->
<!-- mean_PagB <- mean(page_B)  -->
<!-- tapply(Time, Page, summary) -->
<!-- ``` -->
...
<!-- # Intervalos de Confiança (06/10/2020) -->
